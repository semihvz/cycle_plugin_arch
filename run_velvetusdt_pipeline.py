...
def fetch_klines(symbol="VELVETUSDT", interval="1h", limit=720):
...
def main():
    ...
    fixed_pos_size = 50.0
    lookback = 100
    db_path = "/home/smhvz/Desktop/cycle-orc/velvetusdt_collector.db"

    print("==========================================================================================")
    print(f"🔥 VELVETUSDT {interval} (SON 1 AY) VERİ TOPLAMA, SQLITE KAYIT VE ML PİPELİNE")
    print("==========================================================================================")
    ...
    bars = fetch_klines(symbol, interval, 720)
    print(f"Total 1h bars fetched for {symbol}: {len(bars)}")
    ...
    # Save Excel and CSV for VELVETUSDT
    excel_path = "/home/smhvz/Desktop/cycle-orc/velvetusdt_closed_trades.xlsx"
    csv_path = "/home/smhvz/Desktop/cycle-orc/velvetusdt_closed_trades.csv"
    ...
    print(f"\n📊 {symbol} 1h Backtest ve Veri Toplama Tamamlandı:")
    print(f"   • Toplam Kapanmış İşlem : {len(df)} adet")
    ...
    # Machine Learning Model Training on VELVETUSDT 1h
    feature_cols = [
    ...
    print("------------------------------------------------------------------------------------------")
    print(f"🤖 MAKİNE ÖĞRENMESİ ({symbol} 1h MODELİ) PERFORMANSI:")
    print("------------------------------------------------------------------------------------------")
    ...
    print(f"{'Ham Strateji (1h)':<18} | {len(df):<12} | %{(y.mean()*100):<13.2f} | {base_pnl:<+15.2f} | {base_pf:<13.2f}")
    ...
    # Fit final model
    rf.fit(X_scaled, y)
    joblib.dump(rf, "/home/smhvz/Desktop/cycle-orc/ml_model_suite/models/velvetusdt_1h_ml_model.joblib")
    joblib.dump(scaler, "/home/smhvz/Desktop/cycle-orc/ml_model_suite/models/velvetusdt_scaler.joblib")

    # Live Inference on latest VELVETUSDT 1h Binance Futures Candles
    print("==========================================================================================")
    print(f"⚡ {symbol} 1h CANLI PİYASA İNFERENCE (TAHMİN) TESTİ:")
    print("==========================================================================================")
    bars_live = fetch_klines(symbol, "1h", 100)
    ...
    print(f"📊 Sembol: {symbol} 1h | Canlı Kapanış Fiyatı: {entry_p} USDT")
    print(f"🎯 Yapay Zeka VELVETUSDT Kazanma Olasılığı: %{live_win_prob*100:.2f}")
