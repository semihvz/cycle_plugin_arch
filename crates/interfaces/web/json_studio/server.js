...
const KNOWN_PLUGINS = [
  ...
  {
    name: 'plugin_bookticker_derivatives',
    category: 'Analytics',
    description: 'Bookticker 1., 2. ve 3. derece türev (hız, ivme, sarsıntı) analizi',
    default_outputs: ['stream_bookticker_derivatives'],
    default_params: { window_ms: 30000 }
  },
  {
    name: 'plugin_amihud',
    category: 'Analytics / Liquidity',
    description: 'Amihud İllikidite Oranı (1M $ başına getiri/hacim duyarlılığı) analizi',
    default_outputs: ['stream_amihud_metrics'],
    default_params: { window_ms: 60000 }
  }
];
