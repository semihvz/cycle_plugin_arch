...
def fetch_klines(symbol="TACUSDT", interval="1m", limit=1500):
...
def main():
    ...
    db_path = os.path.join(data_dir, "tacusdt_1m_collector.db")

    print("==========================================================================================")
    print(f"⚡ TACUSDT {interval} (1-DAKİKALIK MUM) VERİ TOPLAMA, SQLITE KAYIT VE ML PİPELİNE")
    print("==========================================================================================")
    ...
    print(f"   • Toplam Kapanmış İşlem : {len(df)} adet 1m işlem")
    ...
    # Machine Learning Model Training on 1m
    feature_cols = [
    ...
    rf.fit(X_scaled, y)
    joblib.dump(rf, "/home/smhvz/Desktop/cycle-orc/ml_model_suite/models/tacusdt_1m_ml_model.joblib")
    joblib.dump(scaler, "/home/smhvz/Desktop/cycle-orc/ml_model_suite/models/scaler_1m.joblib")

    # Live Inference on latest 1m Binance Futures Candles
    print("==========================================================================================")
    print(f"⚡ {symbol} 1m CANLI PİYASA İNFERENCE (TAHMİN) TESTİ:")
    print("==========================================================================================")
    bars_live = fetch_klines(symbol, "1m", 120)
    ...
    print(f"🎯 Yapay Zeka TACUSDT 1m Kazanma Olasılığı: %{live_win_prob*100:.2f}")
